...
#scatterplot von Plotly https://plotly.com/python/line-and-scatter mit den Daten aus der Funktion data.wiedergabe()
#Daten stammen aus der Funktion wiedergabe() in daten.py. Hier wird nur der typ scatterplot aufgerufen.
...
def viz():
    dauer, distanz, kalorien, datum, sportart = daten.wiedergabe("scatterplot")
