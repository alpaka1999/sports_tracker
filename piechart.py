...
#fig.show() öffnet ein eigenes Browserfenster. Daher div, um Diagramm im Sports Tracker anzeigen zu können
def viz():
    dauer, sportart = data()
    fig = px.pie(values=dauer, names=sportart, title="Erfasste Sportarten dargestellt nach Dauer")
